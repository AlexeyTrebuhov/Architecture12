...
namespace ClinicServiceTests
{
    ...
    public class PetControllerTests
    {
        ...
        public void PetUpdateTest()
        {
            ...
            updatePetRequest.Name = updatePetRequest.Name;
            updatePetRequest.Birthday = updatePetRequest.Birthday;
            updatePetRequest.ClientId = updatePetRequest.ClientId;
        ...
        {
            // [1] Подготовка данных для тестирования
            GetAllPetRequest getAllPetRequest = new GetAllPetRequest();

            // [2] Исполнение тестируемого метода
            ActionResult<List<Pet>> operationResult = _petController.GetAll(getAllPetRequest);
            ...
            Assert.IsType<OkObjectResult>(operationResult.Result);
            //Assert.Equal<List>(        expectedOperationValue, (int)((OkObjectResult)operationResult.Result).Value);
        }
        ...
        {
            // [1] Подготовка данных для тестирования
            var getByIdTest = new GetByIdTest(petId);

            // [2] Исполнение тестируемого метода
            ActionResult<int> operationResult = _petController.GetByIdTest(petId);
