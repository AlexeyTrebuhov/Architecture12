...
namespace ClinicService.Controllers
{
    ...
    public class PetController : ControllerBase
    {
        ...
        public ActionResult<int> Update(object updatePetRequest)
        {
            throw new NotImplementedException();
        }

        public ActionResult<int> GetAll(global::ClinicServiceTests.GetAllPetRequest getAllPetRequest)
        {
            throw new NotImplementedException();
        }
        ...
        public ActionResult<int> GetAll(PetController petController)
        {
            throw new NotImplementedException();
        }
        ...
        public ActionResult<int> GetByIdTest(int petId)
        {
            throw new NotImplementedException();
        }
    }
